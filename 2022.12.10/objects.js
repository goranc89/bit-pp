...
//     sugar: "without"
//     }
// var coffee1 = [["name", "long espresso"], ["strength", "strong"], ["flavour", "vanilla"], ["milk", "with"], ["sugar", "without"]];
...
//     actors: ["Sam Wortinghton", "Zoe Saldana", "Sigourney Weaver", "Kate Winslet", "Vin Diesel"],
//     genre: "Sci-Fi",
//     popularity: "7"
// }
...
//     return object.ingredients;
// }
// console.log(deleteIngrediant(recipe, "sir")); //odraditi sa izbacivanjem ingredienta iz niza
...
// var groceries = [   {"product": "milk", "quantity": 1, "price": 1.50}, 
//                     {"product": "bread", "quantity": 2, "price": 1.10}, 
//                     {"product": "meat", "quantity": 0.5, "price": 3.50}];
...
// var jewelry = [{"name":"Diamond earings", "price": 980}, {"name":"Gold watch", "price":250}, {"name":"Diamond ring", "price":1100}];
...
//     for (i = 0; i < arr.length; i++) {
//         if (arr[i].price == max) {
//             return "The most expensive one is the " + arr[i].name + " " + arr[i].price;
//         }
//     }
//    return max;
// }
...
console.log(mapLetters("froggy")); //preuzeto sa https://www.tutorialspoint.com/mapping-the-letter-of-a-string-to-an-object-of-arrays-javascript
...
//         rgb += "0";
//     }
//     return rgb + object.green.toString(16) + object.blue.toString(16);
// }
